...
<v-layout row wrap>
    ...
    <HeaderNavigation @toggle-drawer="$refs.navbar.drawer = !$refs.navbar.drawer"></HeaderNavigation>
    <div class="body-content">
        ...
        <b-modal id="error-modal" hide-footer>
            ...
            <div class="d-block text-center">
                <div>
                    <span>{{errror_messgae}}</span>
                </div>
            </div>
            <div style="float: right;">
                <b-button class="mt-3" style="margin-right:10px" v-show="currentStep == 4" @click="this.$router.push('/profile')">ปิด</b-button>
            </div>
        </b-modal>
        <div class="bg-content">
            <div id="step1" v-show="currentStep == 1">
                <div>
                    <b-modal id="bv-modal-upload1" size="xl" hide-footer hide-header-close no-close-on-esc no-close-on-backdrop>
                        ...
                        <div class="d-block text-center">
                            <div>
                                <Cropper @change="change" :src="step1.imgSelectUpload" class="cropper" image-class="cropper__image" :stencil-props="{
                            ...
                            <v-col md="12" sm="12" cols="12">
                                <v-card class="mx-auto" style="">
                                    <div class="image-card">
                                        <img class="image-cf" v-if="step1.dataRequest.imgConfirm != ''" :src="step1.dataRequest.imgConfirm" />
            ...
            <div id="step2" v-show="currentStep == 2">
                <div>
                    <b-modal id="bv-modal-upload2" size="xl" hide-footer hide-header-close no-close-on-esc no-close-on-backdrop>
                        ...
                        <div class="d-block text-center">
                            <div>
                                <Cropper @change="change" :src="step2.imgSelectUpload" class="cropper" image-class="cropper__image" :stencil-props="{
                      class: 'cropper-stencil',
                      previewClass: 'cropper-stencil__preview',
                      draggingClass: 'cropper-stencil--dragging',
                      handlersClasses: {
                    ...
                    <v-form ref="form2" v-model="valid" lazy-validation>
                        <v-row>
                            <v-col md="12" sm="12" cols="12">
                                <v-card class="mx-auto" style="">
                                    <div class="image-card">
                                        <img class="image-cf" v-if="step2.dataRequest.imgConfirm != ''" :src="step2.dataRequest.imgConfirm" />
                      ...
                      <v-icon>mdi-camera</v-icon>
                            ...
                            <v-col md="12" sm="12" cols="12">เบอร์โทรติดต่อ<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="12" sm="12" cols="12">ที่อยู่<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="12" sm="12" cols="12">จังหวัด<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">

                                <v-select :items="this.selectOption.memberProvince" v-model="step2.dataRequest.memberProvince" name="memberProvince" label="เลือกจังหวัด" dense solo required :rules="dataRules" v-on:change="changeProvince"> </v-select>
                            </v-col>
                            <v-col md="12" sm="12" cols="12">อำเภอ<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                                <v-select :items="this.selectOption.memberDistrict" v-model="step2.dataRequest.memberDistrict" name="memberDistrict" label="เลือกอำเภอ" dense solo required :rules="dataRules" v-on:change="changeDistrict"> </v-select>
                            </v-col>
                            <v-col md="12" sm="12" cols="12">ตำบล<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                                <v-select :items="this.selectOption.memberSubDistrict" v-model="step2.dataRequest.memberSubDistrict" name="memberSubDistrict" label="เลือกตำบล" dense solo required :rules="dataRules" v-on:change="changeSubDistrict"> </v-select>
                            </v-col>
                            <v-col md="12" sm="12" cols="12">รหัสไปรษณีย์<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
            ...
            <div id="step3" v-show="currentStep == 3">
                <div>
                    <b-modal id="bv-modal-upload3" size="xl" hide-footer hide-header-close no-close-on-esc no-close-on-backdrop>
                        ...
                        <div class="d-block text-center">
                            <div>
                                <Cropper @change="change" :src="step3.imgSelectUpload" class="cropper" image-class="cropper__image" :stencil-props="{
                      class: 'cropper-stencil',
                      previewClass: 'cropper-stencil__preview',
                      draggingClass: 'cropper-stencil--dragging',
                      handlersClasses: {
                    ...
                    <v-form ref="form3" v-model="valid" lazy-validation>
                        <v-row>
                            <v-col md="12" sm="12" cols="12">
                                <v-card class="mx-auto" style="">
                                    <div class="image-card">
                                        <img class="image-cf" v-if="step3.dataRequest.imgConfirm != ''" :src="step3.dataRequest.imgConfirm" />
                      ...
                      <v-icon>mdi-camera</v-icon>
                            ...
                            <v-col md="12" sm="12" cols="12">เต็นท์รถ<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="12" sm="12" cols="12">รหัสบนการ์ดสมาชิก<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="12" sm="12" cols="12">ยื่ห้อรถยนต์<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                                <v-select :items="this.selectOption.carBrand" v-model="step3.dataRequest.carBrand" name="carBrand" label="-- Please Select --" dense solo required :rules="dataRules" v-on:change="changeCarBrand"> </v-select>
                            </v-col>
                            <v-col md="12" sm="12" cols="12">รุ่นรถยนต์<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="6" sm="6" cols="6">รหัสตัวถัง<span style="color:red">*</span></v-col>
                            <v-col md="6" sm="6" cols="6">รหัสเครื่องยนต์<span style="color:red">*</span></v-col>
                            <v-col md="6" sm="6" cols="6">
                            ...
                            <v-col md="6" sm="6" cols="6">จังหวัดที่ลงทะเบียน<span style="color:red">*</span></v-col>
                            <v-col md="6" sm="6" cols="6">ทะเบียนรถ<span style="color:red">*</span></v-col>
                            <v-col md="6" sm="6" cols="6">
                            ...
                            <v-col md="6" sm="6" cols="6">เลขไมล์ตั้งต้น<span style="color:red">*</span></v-col>
                            <v-col md="6" sm="6" cols="6">ความจุเครื่องยนต์<span style="color:red">*</span></v-col>
                            <v-col md="6" sm="6" cols="6">
                            ...
                            <v-col md="12" sm="12" cols="12">ปีที่ผลิตรถยนต์<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="12" sm="12" cols="12">วันที่ออกรถยนต์<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
            ...
            <div id="step4" v-show="currentStep == 4">
                <b-modal id="bv-modal-cf" size="xl" hide-footer>
                    ...
                    <div class="d-block text-center">
                        <div>
                            <b-form-textarea v-model="step4.dataRequest.remark" id="textarea-rows" placeholder="หมายเหตุ" rows="8"></b-form-textarea>
                        </div>
                    </div>
                    <div style="text-align: center;">
                        <b-button pill class="btn-step" @click="setActivate()" style="width:30%;margin-top:20px">ตกลง</b-button>
                    </div>
                </b-modal>
                <div class="content">
                    <v-form ref="form4" v-model="valid" lazy-validation>
                        <v-row>
                            <v-col md="12" sm="12" cols="12">ประเภทแพ็กเกจ<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                                <v-select :items="this.selectOption.packege" v-model="step4.dataRequest.packege" required :rules="dataRules" solo name="packege" label="เลือกประเภท package"> </v-select>
                            </v-col>
                            <v-col md="12" sm="12" cols="12">วันที่ซื้อแพ็กเกจ<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="12" sm="12" cols="12">ระยะความคุ้มครอง (เดือน)<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
                            ...
                            <v-col md="12" sm="12" cols="12">ระยะความคุ้มครอง (กิโลเมตร)<span style="color:red">*</span></v-col>
                            <v-col md="12" sm="12" cols="12">
...
export default {
    data() {
        return {
            errror_messgae: "activate error somthing when wrong",
    ...
    mounted: function () {
        this.clearState()
        this.$store.getters.StateProvince.forEach(el => this.selectOption.memberProvince.push({
            value: el.id,
            text: el.name_th
        }))
        this.$store.getters.StateCard.forEach(el => this.selectOption.memberCard.push({
            value: el.id,
            text: el.text
        }))
        this.$store.getters.StateCarBrand.forEach(el => this.selectOption.carBrand.push({
            value: el.id,
            text: el.name
        }))
        this.$store.getters.StateProvince.forEach(el => this.selectOption.carProvince.push({
            value: el.id,
            text: el.name_th
        }))
        this.$store.getters.StateCarColor.forEach(el => this.selectOption.carColor.push({
            value: el.id,
            text: el.name_th
        }))
    ...
    methods: {
        async changeProvince(id) {
            ...
            this.step2.dataRequest.memberDistrict = null
            this.step2.dataRequest.memberSubDistrict = null
            this.selectOption.memberDistrict = []
            this.selectOption.memberSubDistrict = []
            console.log(this.$store.getters.StateDistrict);
            this.$store.getters.StateDistrict.forEach(el => this.selectOption.memberDistrict.push({
                value: el.id,
                text: el.name_th
            }))
        ...
        async changeDistrict(id) {
            console.log(id);
            await this.getSubDistrict(id)
            this.step2.dataRequest.memberSubDistrict = null
            this.selectOption.memberSubDistrict = []
            this.$store.getters.StateSubDistrict.forEach(el => this.selectOption.memberSubDistrict.push({
                value: el.id,
                text: el.name_th
            }))
        },

        async changeCarBrand(id) {
            console.log(id);
            await this.getCarModel(id)
            this.step3.dataRequest.carModel = null
            this.selectOption.carModel = []
            this.$store.getters.StateCarModel.forEach(el => this.selectOption.carModel.push({
                value: el.id,
                text: el.name
            }))
        },
        ...
        async validateStep(step) {
            if (step === 1) {
                ...
                if (this.$refs.form2.validate() && this.step2.isCompleteValid) {
                    await this.createCustomer(this.step2.dataRequest)
                    if (typeof this.$store.getters.StateAddCustomer.status !== undefined && this.$store.getters.StateAddCustomer.status === true) {
                        this.currentStep += 1
                        this.scrollToTop()
                    } else {
                        //alert(this.$store.getters.StateAddCustomer.message)
                        this.errror_messgae = this.$store.getters.StateAddCustomer.message
        ...
        async setActivate() {
            await this.createActive(this.step1.dataRequest, this.step2.dataRequest, this.step3.dataRequest, this.step4.dataRequest)
        },
        backStep() {
        ...
        async getDistrict(id) {
            try {
                const s = await this.GetDistrict(id)
                console.log(s);
            } catch (error) {
                console.log(error)
            }
        ...
        async createCustomer(form) {
            ...
            Customer.append('customer_name', form.memberName)
            Customer.append('customer_surname', form.memberSurName)
            Customer.append('birth_date', form.birthDate)
            Customer.append('gender', form.sexMember)
            Customer.append('id_card', form.idenNumber)
            Customer.append('tel', form.memberPhone)
            Customer.append('email', form.memberEmail)
            Customer.append('line_id', form.memberLineID)
            Customer.append('formal_address', form.memberAddress)
            Customer.append('formal_province_id', form.memberProvince)
            Customer.append('formal_amphure_id', form.memberDistrict)
            Customer.append('formal_tumbon', form.memberSubDistrict)
            Customer.append('formal_post_code', form.memberZipCode)
            Customer.append('current_address', form.memberAddress)
            Customer.append('current_province_id', form.memberProvince)
            Customer.append('current_amphure_id', form.memberDistrict)
            Customer.append('current_tumbon_id', form.memberSubDistrict)
            Customer.append('current_post_code', form.memberZipCode)
        ...
        async createActive(form1, form2, form3, form4) {
            console.log(form4);
            ...
            Active.append('car_brand_id', form3.carBrand)
            Active.append('car_model_id', form3.carModel)
            Active.append('car_year', form3.carYear)
            Active.append('car_register_num', form3.cardId)
            Active.append('car_province_id', form3.carProvince)
            Active.append('car_vin', form3.tankNumber)
            Active.append('engine_code', form3.machineNumber)
            Active.append('car_mile', form3.mileage)
            Active.append('car_date', form3.carDate)
            Active.append('car_cc', form3.capCar)
            Active.append('car_color1', form3.carColor1)
            Active.append('car_color2', form3.carColor2)
            Active.append('car_color3', form3.carColor3)
            Active.append('warranty_status')

            try {
                await this.CreateActive(Active)
                console.log(this.$store.getters.StateAddActive)
...
.btn-step {
    ...
    background: linear-gradient(to right, #041427, #092d4a, #041427);
    box-shadow: 0px 3px 4px 0px #ab9f9f;
    width: 60%;
}
